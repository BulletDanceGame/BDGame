...
public class AkSoundEngineController
{
    ...
    public void LateUpdate()
    {
        ...
        //UnityEngine.Debug.Log("update wwise " + Time.realtimeSinceStartupAsDouble + " frames " + frames);
        if (starting)
        {
            frames++;
            ...
            else if (frames > frameDelay) //if a delay happens here, its nothing that can be done
            {
