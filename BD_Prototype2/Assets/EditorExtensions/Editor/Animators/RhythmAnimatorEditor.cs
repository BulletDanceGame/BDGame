...
{
    [CustomEditor(typeof(RhythmAnimator), true)]
    public class RhythmAnimatorEditor : UnityEditor.Editor
    {
        public VisualTreeAsset _inspectorXML;
        VisualElement inspector;

        List<string> _excludedProperties = new List<string>() { "m_Script", "_animType", "_animator", "_spriteAnimator", "_layeredAnimator" };
