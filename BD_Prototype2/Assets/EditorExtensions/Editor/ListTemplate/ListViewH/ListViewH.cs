...
public class ListViewH : BaseListViewH
{
    ...
    protected override BulletDance.Editor.CollectionViewController CreateViewController() =>
        (BulletDance.Editor.CollectionViewController)new ListViewHController();
