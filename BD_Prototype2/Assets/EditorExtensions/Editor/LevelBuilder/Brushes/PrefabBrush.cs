...
namespace BulletDance.LevelBuilder
{
    ...
    {
        [Header("Settings to make operations on smaller grids easier.")]

        [Tooltip("Paints the object every [spacing] tiles.\nEx. 20 spacing = the object is painted every 20 tiles.")]
        [Range(1, 200)]
        [SerializeField]
        private int spacing = 1;
        private int currentSpaceCount = 0;

        [Tooltip("Enlarges the eraser")]
        [Range(1, 15)]
        [SerializeField]
        private int eraseSizeMulti = 10;
        ...
        {
            currentSpaceCount = spacing;
        }

        /// <summary>
        /// Initializes the content of the PrefabBrush.
        /// </summary>
        /// <param name="size">Size of the PrefabBrush.</param>
        ...
        /// <summary>Initializes the content of the PrefabBrush.</summary>
        /// <param name="size">Size of the PrefabBrush.</param>
        /// <param name="pivot">Pivot point of the PrefabBrush.</param>
        ...
        /// The PrefabBrush overrides this to provide GameObject painting functionality.
        /// </summary>
        ...
        /// The PrefabBrush overrides this to provide GameObject erasing functionality.
        /// </summary>
        /// <param name="gridLayout">Grid used for layout.</param>
        ...
        {
            Vector3Int min = position - pivot;
            BoundsInt bounds = new BoundsInt(min, m_Size*eraseSizeMulti);
        ...
        /// The PrefabBrush overrides this to provide GameObject box-filling functionality.
        /// </summary>
        ...
        /// The PrefabBrush overrides this to provide GameObject box-erasing functionality.
        /// </summary>
        ...
        /// The PrefabBrush overrides this to provide GameObject picking functionality.
        /// </summary>
        ...
        /// The PrefabBrush overrides this to provide GameObject moving functionality.
        /// </summary>
        /// <param name="gridLayout">Grid used for layout.</param>
        ...
        /// <summary>Gets the index to the PrefabBrush::ref::BrushCell based on the position of the BrushCell.</summary>
        ...
        /// <summary>Gets the index to the PrefabBrush::ref::BrushCell based on the position of the BrushCell. Wraps each coordinate if it is larger than the size of the PrefabBrush.</summary>
        /// <param name="x">X Position of the BrushCell.</param>
        /// <param name="y">Y Position of the BrushCell.</param>
        /// <param name="z">Z Position of the BrushCell.</param>
        /// <returns>The cell index for the position of the BrushCell.</returns>
    ...
    /// </summary>
    [UnityEditor.CustomEditor(typeof(PrefabBrush))]
    public class PrefabBrushEditor : GridBrushEditorBase
    {
        private bool hiddenGridFoldout;
        private UnityEditor.Editor hiddenGridEditor;

        /// <summary>
        /// The PrefabBrush for this Editor
        /// </summary>
        public PrefabBrush brush { get { return target as PrefabBrush; } }
        ...
        /// The PrefabBrush Editor overrides this to draw the preview of the brush when drawing lines.
        /// </summary>
        /// <param name="gridLayout">Grid that the brush is being used on.</param>
        /// <param name="brushTarget">Target of the PrefabBrush::ref::Tool operation. By default the currently selected GameObject.</param>
        /// <param name="position">Current selected location of the brush.</param>
        /// <param name="tool">Current PrefabBrush::ref::Tool selected.</param>
        ...
        /// <summary>
        /// Callback for painting the inspector GUI for the PrefabBrush in the tilemap palette.
        /// The PrefabBrush Editor overrides this to show the usage of this Brush.
        /// </summary>
        public override void OnPaintInspectorGUI()
        {
            ...
            if (hiddenGridFoldout)
            {
                ...
                using (new EditorGUI.DisabledScope(GridPaintingState.scenePaintTarget != brush.hiddenGrid))
                {
                    ...
                    {
                        hiddenGridEditor = UnityEditor.Editor.CreateEditor(brush.hiddenGrid.GetComponent<Grid>());
                    }
        ...
        /// <summary>
        /// The targets that the PrefabBrush can paint on
        /// </summary>
